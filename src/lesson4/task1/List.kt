...
fun roman(n: Int): String {
    ...
    val roman = thousands[n / 1000] + hundreds[n % 1000 / 100] + tens[n % 100 / 10] + singles[n % 10]
    return roman
}
...
fun russian(n: Int): String {
    ...
    //вспомогательные
    val e = if (n % 10000 / 1000 == 2) "две " else a[n % 10000 / 1000]
    val f = if (n % 100000 / 10000 == 1) d[n % 10000 / 1000] else b[n % 100000 / 10000] + e
    val g = if (n % 100 / 10 == 1) d[n % 10] else b[n % 100 / 10] + a[n % 10]
    val h = if (n % 10000 / 1000 > 4 || n % 10000 / 1000 == 0 || n % 100000 / 10000 == 1) "тысяч " else "тысячи "
    //ответ
